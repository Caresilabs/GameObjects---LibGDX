...
public class SpatialHashGrid {
    ...
    protected SpatialHashGrid(float worldWidth, float worldHeight, float cellSize) {
    ...
    public int[] getCellIds(GameObject obj) { 
        int x1 = (int)MathUtils.floor(obj.bounds.x / cellSize);
        int y1 = (int)MathUtils.floor(obj.bounds.y / cellSize);
        int x2 = (int)MathUtils.floor((obj.bounds.x + obj.bounds.width) / cellSize);
        int y2 = (int)MathUtils.floor((obj.bounds.y + obj.bounds.height) / cellSize);
